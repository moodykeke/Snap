...
SnapTranslator.dict.zh_CN = { ...SnapTranslator.dict.zh_CN,
    ...
    "group": "group",
    "extension": "extension",
    "Enter one option per line.\\n' +\r\n            'Optionally use \"=\" as key/value delimiter ' +\r\n            'and {} for submenus. ' +\r\n            'e.g.\\n   the answer=42": "Enter one option per line.\\n' +\r\n            'Optionally use \"=\" as key/value delimiter ' +\r\n            'and {} for submenus. ' +\r\n            'e.g.\\n   the answer=42",
    "Enter one item per line.": "Enter one item per line.",
    ...
    "hide holes": "hide holes",
    "show holes": "show holes",
    "dial": "dial",
    ...
    "A variable with this name already exists.": "A variable with this name already exists.",
    "Edge color\\n(left click)": "Edge color\\n(left click)",
    "Fill color\\n(right click)": "Fill color\\n(right click)",
    "a variable of name": "a variable of name",
    "does not exist in this context": "does not exist in this context",
    "CSV": "CSV",
    "JSON": "JSON",
    "cannot send media,\\nsprites or procedures\\nto another scene": "cannot send media,\\nsprites or procedures\\nto another scene",
    "unable to nest\\n(disabled or circular?)": "unable to nest\\n(disabled or circular?)",
    "there are currently no\\nvectorizable pen trail segments": "there are currently no\\nvectorizable pen trail segments",
    "C": "C",
    "Snap! can only import \"text\" files.\\n' + 'You selected a file of type \"' + ftype + '\".": "Snap! can only import \"text\" files.\\n' + 'You selected a file of type \"' + ftype + '\".",
    "SciSnap! manual": "SciSnap! manual",
    "SciSnap! Handbuch": "SciSnap! Handbuch",
    "Connection closed.": "Connection closed.",
    "Escape microworld": "Escape microworld",
